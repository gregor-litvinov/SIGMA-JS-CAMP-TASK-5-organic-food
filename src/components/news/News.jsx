    ...
    <>
      <div className="news-wraper">
        <div className="container">
          ...
          <MyButton variant="news">More News</MyButton>
          </div>
        </div>
        <div className="news-paper-wrap">
          <div className="news-paper-block block1">
            <div className="news-paper-block-data">
              <div className="data-paper-numb st">25</div>
              <div className="data-paper-mont st">Nov</div>
            </div>
            <div className="news-block-wrap">
              <div className="news-block-wrap-content">
                <div className="avtor-news">
            ...
            <div className="news-paper-block block2">
            <div className="news-paper-block-data">
              <div className="data-paper-numb st">25</div>
              <div className="data-paper-mont st">Nov</div>
            </div>
